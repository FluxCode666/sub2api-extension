...
import TicketNotificationSettings from '@/pages/admin/TicketNotificationSettings'
...
export default function NotificationManagementPage() {
  ...
  return <div className="aux-admin-page space-y-6">
    <div><h1 className="flex items-center gap-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100"><Bell className="h-6 w-6" />消息通知管理</h1><p className="mt-1 text-sm text-muted-foreground">配置通知渠道及发票申请、新工单提醒，查看通知投递日志。</p></div>
    ...
    <TicketNotificationSettings channels={channels} />
