...
供 `/client-docs` 的客户端选择、目录与指南标题使用。资源保存在本地，运行时无需请求第三方站点。获取日期：2026-09-09。
...
| `openclaw.svg` | [OpenClaw 官网 favicon](https://openclaw.ai/favicon.svg) |
| `paseo.svg` | [Paseo 官网 logo](https://paseo.sh/logo.svg) |
| `zcode.png` | [ZCode 官网 192px 图标](https://zcode.z.ai/favicon-192x192.png?v=20260707-transparent) |
| `deepseek-harness.svg` | [DeepSeek Harness 官方文档 favicon](https://deepseek-harness.github.io/deepseek-harness/favicon.svg) |
| `obsidian.svg` | [Obsidian 官网渐变标志](https://obsidian.md/images/obsidian-logo-gradient.svg) |
