...
func (_c *PageCreate) SetVisibility(v string) *PageCreate {
	_c.mutation.SetVisibility(v)
	return _c
}

// SetNillableVisibility sets the "visibility" field if the given value is not nil.
func (_c *PageCreate) SetNillableVisibility(v *string) *PageCreate {
	if v != nil {
		_c.SetVisibility(*v)
	}
	return _c
...
func (_c *PageCreate) SetContentType(v string) *PageCreate {
	_c.mutation.SetContentType(v)
	return _c
}

// SetNillableContentType sets the "content_type" field if the given value is not nil.
func (_c *PageCreate) SetNillableContentType(v *string) *PageCreate {
	if v != nil {
		_c.SetContentType(*v)
	}
	return _c
...
func (_c *PageCreate) SetContentReact(v string) *PageCreate {
	_c.mutation.SetContentReact(v)
	return _c
}

// SetNillableContentReact sets the "content_react" field if the given value is not nil.
func (_c *PageCreate) SetNillableContentReact(v *string) *PageCreate {
	if v != nil {
...
func (_c *PageCreate) SetEnabled(v bool) *PageCreate {
	_c.mutation.SetEnabled(v)
	return _c
}

// SetNillableEnabled sets the "enabled" field if the given value is not nil.
func (_c *PageCreate) SetNillableEnabled(v *bool) *PageCreate {
	if v != nil {
		_c.SetEnabled(*v)
	}
	return _c
...
func (_c *PageCreate) defaults() {
	if _, ok := _c.mutation.Visibility(); !ok {
		v := page.DefaultVisibility
		_c.mutation.SetVisibility(v)
	}
	if _, ok := _c.mutation.ContentType(); !ok {
		v := page.DefaultContentType
		_c.mutation.SetContentType(v)
	}
	if _, ok := _c.mutation.Enabled(); !ok {
		v := page.DefaultEnabled
		_c.mutation.SetEnabled(v)
	}
...
func (_c *PageCreate) check() error {
	...
	if _, ok := _c.mutation.Visibility(); !ok {
		return &ValidationError{Name: "visibility", err: errors.New(`ent: missing required field "Page.visibility"`)}
	}
	...
	if _, ok := _c.mutation.ContentType(); !ok {
		return &ValidationError{Name: "content_type", err: errors.New(`ent: missing required field "Page.content_type"`)}
	}
	...
	if _, ok := _c.mutation.Enabled(); !ok {
		return &ValidationError{Name: "enabled", err: errors.New(`ent: missing required field "Page.enabled"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
