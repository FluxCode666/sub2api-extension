...
func (_q *SupportTicketMessageQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *SupportTicketMessageQuery) FirstIDX(ctx context.Context) int {
...
func (_q *SupportTicketMessageQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *SupportTicketMessageQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *SupportTicketMessageQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *SupportTicketMessageQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SupportTicketMessageQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(supportticketmessage.Table, supportticketmessage.Columns, sqlgraph.NewFieldSpec(supportticketmessage.FieldID, field.TypeInt))
	_spec.From = _q.sql
