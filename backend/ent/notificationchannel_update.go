...
func (_u *NotificationChannelUpdate) SetType(v string) *NotificationChannelUpdate {
	_u.mutation.SetType(v)
	return _u
}

// SetNillableType sets the "type" field if the given value is not nil.
func (_u *NotificationChannelUpdate) SetNillableType(v *string) *NotificationChannelUpdate {
	if v != nil {
		_u.SetType(*v)
	}
	return _u
...
// SetType sets the "type" field.
func (_u *NotificationChannelUpdateOne) SetType(v string) *NotificationChannelUpdateOne {
	_u.mutation.SetType(v)
	return _u
}

// SetNillableType sets the "type" field if the given value is not nil.
func (_u *NotificationChannelUpdateOne) SetNillableType(v *string) *NotificationChannelUpdateOne {
	if v != nil {
		_u.SetType(*v)
	}
	return _u
